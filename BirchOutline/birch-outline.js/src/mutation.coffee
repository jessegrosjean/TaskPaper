...
class Mutation
  ...
  # Public: Read-only {Number} length of the inserted body text in the target
  # {Item}, or null.
  insertedTextLength: null

  # Public: Read-only {Number} length of replaced body text in the target
  # {Item}, or null.
  replacedTextLength: null
  Object.defineProperty @::, 'replacedTextLength',
    get: -> @replacedText.length
