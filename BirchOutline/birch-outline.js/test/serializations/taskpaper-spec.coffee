...
describe 'TaskPaper', ->
  ...
  describe 'Attributes to body text', ->
    ...
    describe 'Inline Syntax Highlighting', ->
      ...
      it 'should highlight email links with .legal extension', ->
        one.bodyString = 'jesse@hogbay.legal'
        one.bodyHighlightedAttributedString.toString().should.equal('(jesse@hogbay.legal/content:""/link:"mailto:jesse@hogbay.legal")')
