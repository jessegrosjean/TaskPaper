...
describe 'DateTimeParser', ->
  ...
  describe 'Relative Dates', ->
    ...
    it 'last unit', ->
      ...
      DateTimeParser.parse('last week', moment: moment).format().should.equal(moment().subtract(1, 'week').startOf('isoweek').format())
    ...
    it 'this unit', ->
      ...
      DateTimeParser.parse('this week', moment: moment).format().should.equal(moment().startOf('isoweek').format())
    ...
    it 'next unit', ->
      ...
      DateTimeParser.parse('next Month', moment: moment).format().should.equal(moment().add(1, 'month').startOf('month').format())
      DateTimeParser.parse('next week', moment: moment).format().should.equal(moment().add(1, 'week').startOf('isoweek').format())
    ...
    it 'named day', ->
      DateTimeParser.parse('monday', moment: moment).format().should.equal(moment().startOf('day').isoWeekday('monday').format())
      DateTimeParser.parse('mon', moment: moment).format().should.equal(moment().startOf('day').isoWeekday('monday').format())
      DateTimeParser.parse('next mon', moment: moment).format().should.equal(moment().startOf('day').isoWeekday('monday').add(1, 'week').format())
      DateTimeParser.parse('last mon', moment: moment).format().should.equal(moment().startOf('day').isoWeekday('monday').subtract(1, 'week').format())
