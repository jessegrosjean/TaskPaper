...
describe 'SpanBuffer', ->
  ...
  describe 'Spans', ->
    ...
    it 'slices spans at text location ', ->
      ...
      spanIndex.sliceSpanAtLocation(0).should.eql(span: spanIndex.getSpan(0), location: 0, spanIndex: 0, spanLocation: 0, spanYOffset: 0)
      spanIndex.sliceSpanAtLocation(6).should.eql(span: spanIndex.getSpan(0), location: 6, spanIndex: 0, spanLocation: 0, spanYOffset: 0)
      spanIndex.toString().should.equal('(onetwo)')
      spanIndex.sliceSpanAtLocation(3).should.eql(span: spanIndex.getSpan(0), location: 3, spanIndex: 0, spanLocation: 0, spanYOffset: 0)
      spanIndex.toString().should.equal('(one)(two)')
      spanIndex.sliceSpanAtLocation(6).should.eql(span: spanIndex.getSpan(1), location: 3, spanIndex: 1, spanLocation: 3, spanYOffset: 10)
      spanIndex.toString().should.equal('(one)(two)')
    ...
    it 'finds span at character index', ->
      spanIndex.insertSpans(0, [
        spanIndex.createSpan('one'),
        spanIndex.createSpan('two')
      ])
      spanIndex.getSpanInfoAtCharacterIndex(0).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 0)
      spanIndex.getSpanInfoAtCharacterIndex(1).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 1)
      spanIndex.getSpanInfoAtCharacterIndex(2).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 2)
      spanIndex.getSpanInfoAtCharacterIndex(3).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 0)
      spanIndex.getSpanInfoAtCharacterIndex(4).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 1)
      spanIndex.getSpanInfoAtCharacterIndex(5).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 2)
    ...
    it 'get choose left span at cursor index', ->
      ...
      spanIndex.getSpanInfoAtLocation(0).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 0)
      spanIndex.getSpanInfoAtLocation(1).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 1)
      spanIndex.getSpanInfoAtLocation(2).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 2)
      spanIndex.getSpanInfoAtLocation(3).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 3)
      spanIndex.getSpanInfoAtLocation(4).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 1)
      spanIndex.getSpanInfoAtLocation(5).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 2)
      spanIndex.getSpanInfoAtLocation(6).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 3)
    ...
    it 'get choose right span at cursor index', ->
      ...
      spanIndex.getSpanInfoAtLocation(0, true).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 0)
      spanIndex.getSpanInfoAtLocation(1, true).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 1)
      spanIndex.getSpanInfoAtLocation(2, true).should.eql(span: spanIndex.getSpan(0), spanIndex: 0, spanLocation: 0, spanYOffset: 0, location: 2)
      spanIndex.getSpanInfoAtLocation(3, true).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 0)
      spanIndex.getSpanInfoAtLocation(4, true).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 1)
      spanIndex.getSpanInfoAtLocation(5, true).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 2)
      spanIndex.getSpanInfoAtLocation(6, true).should.eql(span: spanIndex.getSpan(1), spanIndex: 1, spanLocation: 3, spanYOffset: 10, location: 3)
      (-> spanIndex.getSpanInfoAtLocation(7, true)).should.throw()

    it 'should get spans at yOffset', ->
      spanIndex.insertSpans(0, [
        spanIndex.createSpan('one'),
        spanIndex.createSpan('two')
        spanIndex.createSpan('three')
      ])
      spanIndex.getSpanInfoAtYOffset(0).should.eql(span: spanIndex.getSpan(0), yOffset: 0, spanIndex: 0, spanLocation: 0, spanYOffset: 0)
      spanIndex.getSpanInfoAtYOffset(2).should.eql(span: spanIndex.getSpan(0), yOffset: 2, spanIndex: 0, spanLocation: 0, spanYOffset: 0)
      spanIndex.getSpanInfoAtYOffset(12).should.eql(span: spanIndex.getSpan(1), yOffset: 2, spanIndex: 1, spanLocation: 3, spanYOffset: 10)
      spanIndex.getSpanInfoAtYOffset(30).should.eql(span: spanIndex.getSpan(2), yOffset: 10, spanIndex: 2, spanLocation: 6, spanYOffset: 20)
      spanIndex.getSpanInfoAtYOffset(31).should.eql(span: spanIndex.getSpan(2), yOffset: 11, spanIndex: 2, spanLocation: 6, spanYOffset: 20)
      spanIndex.getSpanInfoAtYOffset(61).should.eql(span: spanIndex.getSpan(2), yOffset: 41, spanIndex: 2, spanLocation: 6, spanYOffset: 20)

  getSpansInYOffsetRange: (topYOffset, bottomYOffset) ->
    range = @getSpanRangeForYOffsetRange(topYOffset, bottomYOffset)
    @getSpans(range.location, range.length)

  getSpanRangeForYOffsetRange: (topYOffset, bottomYOffset) ->
